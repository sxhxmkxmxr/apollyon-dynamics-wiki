...
# 7. wiki/subsystems/physics-backbone.html (Consolidated into Robust Control)
bb_html = """<!DOCTYPE html>
<html lang="en">
<head>
<meta charset="UTF-8">
<meta name="viewport" content="width=device-width,initial-scale=1">
<title>Physics Backbone &middot; Consolidated — Apollyon Dynamics Wiki</title>
<link rel="preconnect" href="https://fonts.googleapis.com">
<link rel="preconnect" href="https://fonts.gstatic.com" crossorigin>
<link href="https://fonts.googleapis.com/css2?family=Newsreader:ital,wght@0,400;0,500;1,400&family=Inter:wght@400;500;600;700&family=JetBrains+Mono:wght@400;500;700&display=swap" rel="stylesheet">
<link rel="stylesheet" href="../css/wiki.css">
...
<div class="crumb"><a href="../index.html">Wiki</a><span>/</span><a href="../index.html#subsystems">Subsystems</a><span>/</span>Notice</div>

<header class="masthead">
  <div class="mast-meta">Architecture update · consolidated subsystem</div>
  <h1>Physics Backbone <span class="sub">&amp; Sim-to-Real Engine</span></h1>
  <p class="standfirst">This technology has been consolidated into the unified primary subsystem authority: <a href="near-envelope-control.html"><strong>Robust Control for Fast Air Platforms</strong></a>.</p>
</header>

<section>
  <div class="note key">
    <div class="t">Subsystem Consolidation Notice</div>
    <p>The <strong>Physics Backbone</strong> and <strong>Sim-to-Real Loop</strong> are an indivisible part of our flight-control capability. To prevent architectural fragmentation, all documentation regarding instrumented telemetry calibration, mismatch identification, and direct-actuator neural training now resides centrally on the <a href="near-envelope-control.html"><strong>Robust Control for Fast Air Platforms</strong></a> specification page.</p>
  </div>

  <p>Key highlights of the unified stack:</p>
  <ul>
    <li><strong>Relentless calibration:</strong> Telemetry mismatches are traced to exact physical terms (aerodynamics, actuator thermal sag, structural resonance) rather than masked as process noise.</li>
    <li><strong>One backbone, modular airframe packages:</strong> Shared core across Ahuti, Nightshade ADX-1, HACM-350, and the Kamikaze USV.</li>
    <li><strong>Direct-actuator evaluation:</strong> 500 Hz neural policy trained against flight-grounded simulation.</li>
  </ul>

  <div style="margin-top: 2rem;">
    <a href="near-envelope-control.html" class="btn" style="display:inline-block; padding: 0.6rem 1.2rem; background:#38bdf8; color:#0f172a; font-weight:600; text-decoration:none; border-radius:4px; font-family:'Inter', sans-serif;">Go to Robust Control for Fast Air Platforms &rarr;</a>
  </div>
</section>

<footer>
  <div>Physics Backbone · Consolidated · Rev 2.0</div>
  <div><a href="../index.html">Wiki root</a> · <a href="../index.html#matrix">Commonality matrix</a></div>
</footer>
...
with open('/home/soham-kumar/soham/apollyon/deck/wiki/subsystems/physics-backbone.html', 'w') as f:
    f.write(bb_html)

# 8. wiki/subsystems/anti-jam-gnss.html (Consolidated into High-Speed GNSS-Denied Nav)
crpa_html = """<!DOCTYPE html>
<html lang="en">
<head>
<meta charset="UTF-8">
<meta name="viewport" content="width=device-width,initial-scale=1">
<title>Anti-Jam GNSS · CRPA &middot; Consolidated — Apollyon Dynamics Wiki</title>
<link rel="preconnect" href="https://fonts.googleapis.com">
<link rel="preconnect" href="https://fonts.gstatic.com" crossorigin>
<link href="https://fonts.googleapis.com/css2?family=Newsreader:ital,wght@0,400;0,500;1,400&family=Inter:wght@400;500;600;700&family=JetBrains+Mono:wght@400;500;700&display=swap" rel="stylesheet">
<link rel="stylesheet" href="../css/wiki.css">
...
<header class="masthead">
  <div class="mast-meta">Architecture update · consolidated subsystem</div>
  <h1>Anti-Jam GNSS <span class="sub">7-Element CRPA</span></h1>
  <p class="standfirst">This technology has been consolidated into the primary navigation subsystem authority: <a href="gnss-denied-navigation.html"><strong>High-Speed GNSS-Denied Navigation</strong></a>.</p>
</header>

<section>
  <div class="note key">
    <div class="t">Subsystem Consolidation Notice</div>
    <p>Multi-element <strong>Controlled Reception Pattern Antenna (CRPA)</strong> spatial nulling and <strong>AI-DSMAC</strong> terrain correlation operate as two stages of a single layered navigational defense. To provide a unified engineering reference, all documentation regarding anti-jam spatial nulling (&gt;45 dB), spoofing angle-of-arrival discrimination, and Mach 0.8 terrain matching now resides centrally on the <a href="gnss-denied-navigation.html"><strong>High-Speed GNSS-Denied Navigation</strong></a> specification page.</p>
  </div>

  <p>Key highlights of the unified stack:</p>
  <ul>
    <li><strong>7-Element indigenous array:</strong> Deep &gt;45 dB digital null steering against 200–250 km radius ground EW emitters across NavIC and GPS frequencies.</li>
    <li><strong>Spatial spoofing discrimination:</strong> Detects false constellation single-point angle collapse.</li>
    <li><strong>Seamless handoff:</strong> Immediate transition to passive AI-DSMAC optical terrain correlation under complete jamming saturation.</li>
  </ul>

  <div style="margin-top: 2rem;">
    <a href="gnss-denied-navigation.html" class="btn" style="display:inline-block; padding: 0.6rem 1.2rem; background:#38bdf8; color:#0f172a; font-weight:600; text-decoration:none; border-radius:4px; font-family:'Inter', sans-serif;">Go to High-Speed GNSS-Denied Navigation &rarr;</a>
  </div>
</section>

<footer>
  <div>Anti-Jam GNSS · Consolidated · Rev 2.0</div>
  <div><a href="../index.html">Wiki root</a> · <a href="../index.html#matrix">Commonality matrix</a></div>
</footer>
...
with open('/home/soham-kumar/soham/apollyon/deck/wiki/subsystems/anti-jam-gnss.html', 'w') as f:
    f.write(crpa_html)

print("Consolidation notice pages written successfully.")
